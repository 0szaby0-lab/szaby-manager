package com.szaby.manager.network.api

import android.util.Log
import com.szaby.manager.BuildConfig
import com.szaby.manager.domain.manager.PreferencesManager
import com.szaby.manager.network.dto.*
import com.szaby.manager.network.service.HttpService
import com.szaby.manager.network.utils.APIFailure
import com.szaby.manager.network.utils.APIResponse
import com.szaby.manager.network.utils.getOrNull
...
class MorpheAPI(
     ...
     *
     * Channel selection logic (mirrors FCM subscription matrix in [com.szaby.manager.util.syncFcmTopics]):
