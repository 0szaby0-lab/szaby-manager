package com.szaby.manager.domain.repository
...
import com.szaby.manager.data.redux.Action
import com.szaby.manager.data.redux.ActionContext
import com.szaby.manager.data.redux.Store
import com.szaby.manager.data.room.AppDatabase
import com.szaby.manager.data.room.AppDatabase.Companion.generateUid
import com.szaby.manager.data.room.apps.installed.SelectionPayload
import com.szaby.manager.data.room.bundles.PatchBundleEntity
import com.szaby.manager.data.room.bundles.PatchBundleProperties
import com.szaby.manager.data.room.bundles.Source
import com.szaby.manager.domain.bundles.*
import com.szaby.manager.domain.manager.PreferencesManager
import com.szaby.manager.network.utils.APIError
import com.szaby.manager.patcher.patch.BundleAppMetadata
import com.szaby.manager.patcher.patch.PatchBundle
...
import com.szaby.manager.data.room.bundles.Source as SourceInfo
...
class PatchBundleRepository(
     ...
     *
     * Used by [com.szaby.manager.worker.UpdateCheckWorker] for background update notifications.
     *
