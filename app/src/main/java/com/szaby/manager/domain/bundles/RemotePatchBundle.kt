package com.szaby.manager.domain.bundles

import com.szaby.manager.domain.bundles.RemotePatchBundle.Companion.CHANGELOG_CACHE_TTL
import com.szaby.manager.domain.manager.PreferencesManager
import com.szaby.manager.network.api.MorpheAPI
import com.szaby.manager.network.dto.MorpheAsset
import com.szaby.manager.network.service.AssetDownloader
import com.szaby.manager.network.service.HttpService
import com.szaby.manager.network.utils.getOrThrow
import com.szaby.manager.util.ChangelogEntry
import com.szaby.manager.util.SOURCE_REPO_URL
import com.szaby.manager.util.compareVersions
import com.szaby.manager.util.releasePageUrl
...
sealed class RemotePatchBundle(
    ...
    protected suspend fun fetchAndCacheEntries(
        ...
        return if (sinceVersion != null)
            com.szaby.manager.util.ChangelogParser.entriesNewerThan(allEntries, sinceVersion)
        else allEntries
    }
