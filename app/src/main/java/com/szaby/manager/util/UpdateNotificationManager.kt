...
import com.szaby.manager.util.UpdateNotificationManager.Companion.CHANNEL_FCM_UPDATES
import com.szaby.manager.util.UpdateNotificationManager.Companion.EXTRA_TRIGGER_UPDATE_CHECK
 ...
 * [com.szaby.manager.ManagerApplication.onCreate].
 */
class UpdateNotificationManager(private val context: Context) {
     ...
     * Called from [com.szaby.manager.worker.UpdateCheckWorker] on non-GMS devices
     * and from [com.szaby.manager.service.MorpheFcmService] on GMS devices.
     */
     ...
     * [com.szaby.manager.ui.viewmodel.MainViewModel.pendingUpdateCheck].
     */
