...
package com.szaby.manager.service
 ...
 *
 * Subscription is managed by [com.szaby.manager.util.syncFcmTopics], which is called
 * whenever the user toggles "Background notifications" or "Use prereleases" in Settings,
 * and on every cold start in [com.szaby.manager.ManagerApplication].
 *
 * ## Message contract
 *
