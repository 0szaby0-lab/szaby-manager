...
package com.szaby.manager.ui.screen.shared
...
import com.szaby.manager.util.batchActionSummary
 ...
 *
 * Callers are responsible for placing [com.szaby.manager.ui.screen.settings.system.InstallerFlowDialogs]
