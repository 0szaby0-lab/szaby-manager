...
class MainViewModel(
    ...
    /**
     * Set by [com.szaby.manager.MainActivity.onNewIntent] when the user taps an FCM
    ...
    /**
     * Set by [com.szaby.manager.MainActivity.handleDeepLinkIntent] when the app is opened
    ...
    /**
     * Set by [com.szaby.manager.MainActivity.handleDeepLinkIntent] when an APK-family file
     * is shared to Morphe via the system share sheet.
     * HomeScreen observes this via LaunchedEffect, triggers
     * [com.szaby.manager.ui.viewmodel.HomeViewModel.handleExternalApkUri], then resets to null.
     */
    ...
    /**
     * A batch patch run requested through [com.szaby.manager.MainActivity.ACTION_BATCH_PATCH].
     *
